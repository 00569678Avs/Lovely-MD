...
const sessdata = config.SESSION_ID.replace("DILSHAN-XD~", '');
...
console.log("CONNECTING LOVELY-MD 🧬...");
...
console.log('LOVELY-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ LOVELY-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ DILSHAN✅*
...
if(senderNumber.includes("94764642432")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("HEY, LOVELY-MD STARTED ✅");
});
